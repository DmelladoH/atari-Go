 ...
 * <P>
 * 2º ITIG - Curso 2017-2018. Interfaz en modo texto del juego. Versión de
 * código incompleto a completar por los alumnos.
 * 
...
public class AtariGo {
	...
	public static void main(String[] args) {
		...
		if (!sonArgumentosValidos(args)) {
			...
			while (!arbitro.estaAcabado()) {
				...
				System.out.println("AtariGo modo texto\n");
				mostrarTablero(arbitro.obtenerTablero());
				mostrarPrompt();
				celda = introducirCelda(teclado, arbitro.obtenerTablero());
	 ...
	 * 
	 * @param ex
	 *            excepción que provoca la interrupción de la ejecución.
	 */
